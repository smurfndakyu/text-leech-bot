...
token="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..8XY3W-H73SwWROMJ84SXdiqPMW8WV1tlKRHoEm33ccI"
...
async def account_login(bot: Client, m: Message):
        ...
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
             ...
             url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..hM33P2ai6ivdzxPPfm01LAd4JWv-vnrSxGXqvCirCSpUfhhofpeqyeHPxtstXwe0'}).json()['url']
                ...
                https://pwplayer-38c1ae95b681.herokuapp.com/pw?url={url}&token={token}
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    filename = res_file
                    await prog.delete(True)
                    await helper.send_vid(bot, m, cc, filename, thumb_path, name, prog)
                    count += 1
                    time.sleep(1)
    ...
    await m.reply_text(f"✅ Successfully Uploaded {raw_text0} Uploaded By - TeamFlower")
